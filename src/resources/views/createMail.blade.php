...
<body id="body" class="bg-zinc-100 overflow-hidden w-[90%] mx-auto">
    ...
    <main class="py-24 mx-auto overflow-auto h-svh">
        <h1 class="font-bold text-3xl my-4">お知らせメール作成</h1>
        <form class="flex flex-col justify-center item-center mx-auto mt-8" action="sendMailComp" method="post">
            @csrf
            <textarea class="w-[80%] mx-auto rounded-[5px] text-2xl" name="info" cols="100" rows="6"></textarea>
            <input type="hidden" name="email" value="{{$email}}">
            <input type="hidden" name="userId" value="{{$userId}}">
            <input type="submit" class="w-[100px] mx-auto my-4 py-2 bg-blue-500 text-white rounded-[5px]" value="送信">
        </form>
    </main>
